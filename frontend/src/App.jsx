...
function StudentPhotoFinder() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="min-h-[calc(100vh-76px)] bg-slate-50 px-4 py-10 sm:px-6 lg:px-8">
  <div className="mx-auto w-full max-w-3xl">
    ...
    <div className="mb-8 text-center">
      ...
      <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-slate-500">
        Select your institution and enter a student roll number
        to find the corresponding student photo.
      </p>
    </div>
            ...
            {options.map((option) => {
              ...
              return (
                <motion.button
                  ...
                  type="button"
                  onClick={() =>
                    handleCollegeChange(option.name)
                  }
                  whileTap={{ scale: 0.98 }}
        ...
        <AnimatePresence mode="wait">
          {imgUrl && (
            ...
            >
              ...
              <div className="mt-4 flex min-h-[320px] items-center justify-center overflow-hidden rounded-xl border border-slate-200 bg-slate-50">
                ...
                {!imageError ? (
                  ...
                  <div className="px-6 py-12 text-center">
                    ...
                    <p className="mx-auto mt-2 max-w-xs text-xs leading-5 text-slate-400">
                      Check the roll number and institution,
                      then try again.
                    </p>
